class Scene1 extends Phaser.Scene {
    ...
    create(){
        ...
        const clickButton1 = this.add.image(1950, 800, 'button1').setScale(0.25).setInteractive().on('pointerdown', () =>this.scene.start("Scene1_01") && this.music.play(musicConf1)); 
        ...
        const clickButton2 = this.add.image(1950, 870, 'button2').setScale(0.25).setInteractive().on('pointerdown', () =>this.scene.start("Scene3_6") && this.music.play(musicConf1));
        ...
        const clickButton3 = this.add.image(1950, 940, 'button3').setScale(0.25).setInteractive().on('pointerdown', () =>this.scene.start("Scene3_2") && this.music.play(musicConf1));
