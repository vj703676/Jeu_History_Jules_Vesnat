class Scene14 extends Phaser.Scene {
    ...
    create(){
        ...
        this.question= this.add.text(1270, 540, '7+6=?', { fontSize: '25px', fill: '#000' }).setScale(2).setDepth(2);
    ...
    fonction1(){
        ...
        this.question.setText("7+6=13").setDepth(2);
        this.textevictoire.setText("C'est la bonne réponse").setDepth(3);
        this.time.addEvent({ delay: 5000, callback: ()=>{ this.scene.start("Scene15");}, loop: false });
