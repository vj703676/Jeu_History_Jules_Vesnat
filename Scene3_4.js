class Scene3_4 extends Phaser.Scene {
    ...
    create(){
      ...
      localStorage.setItem('lastScene', 'Scene3_4');
        ...
        this.niveau= this.add.text(104 , 857, 'Niveau\n  5/7', { fontSize: '25px', fill: '#000' }).setScale(1.1).setDepth(2);
        ...
        this.textevictoire= this.add.text(1400, 660, 'Rendez moi la monnaie  \n sur 80 centimes pour\n une encre de Sienne \n à 34 centimes', { fontSize: '25px', fill: '#000' }).setScale(1.25);
        ...
        const clickButton4 = this.add.image(1030, 180, '10cent').setScale(0.4).setInteractive().on('pointerdown', () =>this.add.image(1030, 700, '10cent').setScale(0.4).setDepth(0)  && D1-- && this.count10.setText(D1) &&  D2++ && this.count4.setText(D2)  );
        ...
        this.count4= this.add.text(1040, 710, '', { fontSize: '32px', fill: '#FFF' }).setScale(1.8).setDepth(1) ;
        ...
        this.count10= this.add.text(1040, 190, '2', { fontSize: '32px', fill: '#FFF' }).setScale(1.8);
    ...
    function limit5(number4){
      ...
      function limit6(number5){
        ...
        const clickButton8 = this.add.image(1190, 880, 'refresh').setScale(0.25).setInteractive().on('pointerdown', () => this.scene.start("Scene3_4")); 
    ...
    incrementClickCount6() {
      ...
      checkscore(){
        if(this.score == this.montant){
            ...
            this.time.addEvent({ delay: 5000, callback: ()=>{  this.scene.start("Scene3_5") ;}, loop: false });
        }else {
