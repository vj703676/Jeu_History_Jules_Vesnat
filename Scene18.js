class Scene18 extends Phaser.Scene {
    ...
    create(){
        ...
        this.question= this.add.text(1260, 540, '57-18=?', { fontSize: '25px', fill: '#000' }).setScale(2).setDepth(2);
    ...
    fonction1(){
        ...
        this.question.setText("57-18=39").setDepth(2);
        this.textevictoire.setText("C'est la bonne réponse").setDepth(3);
        this.time.addEvent({ delay: 5000, callback: ()=>{ this.scene.start("Scene19");}, loop: false });
    }
