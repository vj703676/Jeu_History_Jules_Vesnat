class Scene3_2 extends Phaser.Scene {
    ...
    create(){
      ...
      localStorage.setItem('lastScene', 'Scene3_2');
        ...
        this.niveau= this.add.text(104 , 857, 'Niveau\n  3/7', { fontSize: '25px', fill: '#000' }).setScale(1.1).setDepth(2);
        ...
        this.textevictoire= this.add.text(1400, 660, 'Passez moi 7 euros\n  et 68 centimes pour\n un change de devises', { fontSize: '25px', fill: '#000' }).setScale(1.25);
    ...
    function limit5(number4){
      ...
      function limit6(number5){
        ...
        const clickButton8 = this.add.image(1190, 880, 'refresh').setScale(0.25).setInteractive().on('pointerdown', () => this.scene.start("Scene3_2")); 
    ...
    incrementClickCount6() {
      ...
      checkscore(){
        if((this.score == this.montant) && (this.score1 == this.montant1)){
            ...
            this.time.addEvent({ delay: 5000, callback: ()=>{  this.scene.start("Scene3_2")}, loop: false });
        }
    }
