class Scene3_2 extends Phaser.Scene {
    ...
    create(){
        ...
        this.textevictoire= this.add.text(1500, 560, 'Passez moi 7 euros\n  et 68 centimes pour\n un change de devises', { fontSize: '25px', fill: '#000' }).setScale(1.25);
    ...
    function limit5(number4){
      ...
      function limit6(number5){
        ...
        const clickButton8 = this.add.image(1190, 880, 'refresh').setScale(0.25).setInteractive().on('pointerdown', () => this.scene.start("Scene3_2")&& this.music3.play(musicConf1)); 
