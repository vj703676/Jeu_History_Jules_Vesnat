class Scene1_01 extends Phaser.Scene {
    ...
    create(){
        ...
        localStorage.setItem('lastScene', 'Scene1_01');
        var musicConf1_1 = {
            mute: false,
            volume: 1.5,
            rate: 1,
        ...
        const clickButton = this.add.image(1090, 800, 'ok1').setScale(0.25).setInteractive().on('pointerdown', () =>this.scene.start("Time")&& this.music1_1.play(musicConf1_2) );
