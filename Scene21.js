class Scene21 extends Phaser.Scene {
    ...
    create(){
        ...
        localStorage.setItem('lastScene', 'Scene21');
        ...
        this.niveau= this.add.text(1955, 77, 'Niveau\n  8/9', { fontSize: '25px', fill: '#000' }).setScale(1.1).setDepth(2);
        ...
        this.question= this.add.text(1260, 540, '5×7=?', { fontSize: '25px', fill: '#000' }).setScale(2).setDepth(2);
    ...
    fonction1(){
        ...
        this.question.setText("5×7=35").setDepth(2);
