class Scene21 extends Phaser.Scene {
    ...
    create(){
        ...
        this.question= this.add.text(1260, 540, '5x7=?', { fontSize: '25px', fill: '#000' }).setScale(2).setDepth(2);
        ...
        const clickButton3 = this.add.image(900,270, 'papyrus').setScale(0.5).setInteractive().on('pointerdown', () =>this.fonction2()); 
        ...
        const clickButton4 = this.add.image(200,570, 'papyrus').setScale(0.5).setInteractive().on('pointerdown', () =>this.fonction4());
        ...
        const clickButton8 = this.add.image(550,870, 'papyrus').setScale(0.5).setInteractive().on('pointerdown', () =>this.fonction1()); 
        ...
        this.rep2= this.add.text(530, 250, '14', { fontSize: '25px', fill: '#000' }).setScale(2);

        this.rep3= this.add.text(880, 250, '39', { fontSize: '25px', fill: '#000' }).setScale(2);
        ...
        this.rep8= this.add.text(530, 850, '35', { fontSize: '25px', fill: '#000' }).setScale(2);
    ...
    fonction1(){
        ...
        this.question.setText("5x7=35").setDepth(2);
        this.textevictoire.setText("C'est la bonne réponse").setDepth(3);
        this.time.addEvent({ delay: 5000, callback: ()=>{ this.scene.start("Scene22");}, loop: false });
    }
