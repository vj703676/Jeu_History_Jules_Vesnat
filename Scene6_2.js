class Scene6_2 extends Phaser.Scene {
    ...
    create(){
        ...
        localStorage.setItem('lastScene', 'Scene6_2');

        this.background = this.add.image(1080,520,'FormeTriangle').setScale(1);
        ...
        const clickButton1 = this.add.image(1100, 700, 'Cercle').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
        ...
        const clickButton2 = this.add.image(1500, 700, 'Triangle').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(1)); 
        ...
        const clickButton3 = this.add.image(1100, 900, 'Carre').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
        ...
        const clickButton4 = this.add.image(1500, 900, 'Rectangle').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
