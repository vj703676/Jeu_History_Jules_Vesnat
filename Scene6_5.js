class Scene6_5 extends Phaser.Scene {
    ...
    create(){
        ...
        localStorage.setItem('lastScene', 'Scene6_5');

        this.background = this.add.image(1080,520,'FormeLosange').setScale(1);

        this.background = this.add.image(2020,150,'parchemin2').setScale(0.2).setDepth(1);

        this.niveau= this.add.text(1970, 107, 'Niveau\n  5/9', { fontSize: '25px', fill: '#000' }).setScale(1.1).setDepth(2);


        this.textevictoire= this.add.text(520, 110, 'Quel est le nom\nde cette forme\ngéométrique ?', { fontSize: '25px', fill: '#000' }).setScale(1.25);
       

        const clickButton1 = this.add.image(1100, 700, 'Losange').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(1)); 
        ...
        const clickButton2 = this.add.image(1500, 700, 'Octogone').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
        ...
        const clickButton3 = this.add.image(1100, 900, 'Pentagone').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
        ...
        const clickButton4 = this.add.image(1500, 900, 'Hexagone').setScale(0.35).setInteractive().on('pointerdown', () =>this.checkscore(2)); 
